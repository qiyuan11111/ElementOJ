...
public class GenericBeanDefinition implements com.study.spring.beans.BeanDefinition {

	private Class<?> beanClass;

	private String scope = com.study.spring.beans.BeanDefinition.SCOPE_SINGLETION;
	...
	public boolean isSingleton() {
		return com.study.spring.beans.BeanDefinition.SCOPE_SINGLETION.equals(this.scope);
	}

...
/*
 ...
 V6 加入构造循环依赖检测，错误的实现方式
*/
public class DefaultBeanFactory_v6 implements BeanFactory, BeanDefinitionRegistry, Closeable {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(DefaultBeanFactory_v6.class);
    ...
    //检测构造参数循环依赖的记录器
//    private Set<String> buildingBeans = new HashSet<>();
    ...
    private Object doCreateInstance(com.study.spring.beans.BeanDefinition bd) throws Exception {
        Class<?> type = bd.getBeanClass();

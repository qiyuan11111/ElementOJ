...
import com.study.spring.aop.advisor.AdvisorRegistry;
...
public class AdvisorAutoProxyCreator_back implements AdvisorRegistry, BeanPostProcessor, BeanFactoryAware {
	private List<Advisor> advisors;

	private BeanFactory beanFactory;

	public AdvisorAutoProxyCreator_back() {
